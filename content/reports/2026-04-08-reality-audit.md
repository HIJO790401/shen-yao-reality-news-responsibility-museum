...
body_zh: |
  ...
  建議後續採取固定標註機制，將來源責任與發布責任分欄公開。
body_en: |
  This report audits a three-layer chain: who releases, who bears responsibility, and who verifies.
  We compared source statements, relay nodes, and final accountability and found most risks emerge in the relay layer.
  We recommend a fixed labeling protocol that separates source responsibility from release responsibility in public records.
---
